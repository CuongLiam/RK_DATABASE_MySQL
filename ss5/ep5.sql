...
(2, 'Chuột Logitech', 500000, 50, 300, 'active'),
(3, 'Bàn phím cơ', 1200000, 20, 250, 'active'),
(4, 'Màn hình Samsung', 3500000, 5, 80, 'inactive'),
(5, 'Tai nghe Sony', 900000, 30, 200, 'active'),
(6, 'USB Kingston', 300000, 100, 400, 'active'),
(7, 'Ổ cứng SSD', 2500000, 15, 180, 'active'),
(8, 'Webcam Logitech', 1800000, 25, 160, 'active'),
(9, 'Loa Bluetooth', 1100000, 40, 220, 'active'),
(10, 'Router Wifi', 2000000, 18, 140, 'active'),
(11, 'Chuột Gaming', 700000, 35, 130, 'active'),
(12, 'Tai nghe Gaming', 1600000, 22, 170, 'active');

SELECT * FROM products1 ORDER BY sold_quantity DESC LIMIT 10;

SELECT * FROM products1 ORDER BY sold_quantity DESC LIMIT 5 OFFSET 10;

SELECT * FROM products1 WHERE price < 2000000 ORDER BY sold_quantity DESC;